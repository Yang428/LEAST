...
sys.path.append('/home/wcz/Yang/LEAST/')

from pytracking.tracker.segm_vot20 import Segm
from pytracking.parameter.segm import default_params_vot20 as vot_params
