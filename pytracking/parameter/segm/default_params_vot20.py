...
def parameters():
    ...
    params.max_image_sample_size = (18 * 16) ** 2   # (18 * 16) ** 2   # Maximum image sample size
    params.min_image_sample_size = (18 * 16) ** 2   # (18 * 16) ** 2   # Minimum image sample size
    ...
    params.segm_net_path = '/home/wcz/Yang/LEAST/pytracking/networks/SegmNet.pth.tar'
    params.segm_maskInitNet_path = '/home/wcz/Yang/LEAST/pytracking/networks/SegmNet_maskInitNet.pth.tar'
    ...
    params.segm_surroundings_area_factor = 4.0
